...
import { z } from 'zod';
import { Loader2, ArrowRight, ArrowLeft, Check, X, Clock, TrendingUp, AlertTriangle, Plus, Trash2, CheckCircle } from 'lucide-react';
import {
  Dialog,
  DialogContent,
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex p-1 bg-muted rounded-xl">
                      {[
                        { value: 'doing', label: 'Doing', icon: Clock, activeColor: 'text-primary' },
                        { value: 'done', label: 'Done', icon: Check, activeColor: 'text-green-600' },
                        ...
                        <label key={value} className="flex-1 cursor-pointer">
                          <input
                            ...
                            onChange={() => setValue('status', value as 'doing' | 'done' | 'failed')}
                          />
                          <div
                            className={cn(
                  ...
                  <div>
                    ...
                    <div className="flex flex-col gap-3">
                      {[
                      ...
                      ].map(({ value, label, description, emoji, bgColor, borderColor, activeBg }) => (
                        <label key={value} className="relative group cursor-pointer">
                          <input
                            ...
                            onChange={() => setValue('confidence', value as 'high' | 'medium' | 'low')}
                          />
                          <div
                            className={cn(
