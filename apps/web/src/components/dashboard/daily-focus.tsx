...
export function DailyFocus() {
  ...
  const { getStatusesForWorkspace, getTaskStatusesForWorkspace, getAreaById } = useConfigStore();
  ...
  const focusTasks = projects
    ? getDailyFocusTasks(projects, activeStatusIds, activeTaskStatusIds, 5)
    : [];
