...
export function BoardColumn({
  ...
  return (
    <div
      ref={setNodeRef}
      className={cn(
        'flex h-full min-w-[280px] flex-col rounded-2xl bg-muted/50 md:min-w-[300px] transition-colors',
    ...
    >
      ...
      <div className="flex items-center gap-2 p-4">
        <span
          className={cn('rounded-lg px-2.5 py-1 text-sm font-semibold', colors.bg, colors.text)}
        >
          {statusName}
        </span>
